...
contract SeedRound is WhiteList {
    ...
    function claim() public {
        ...
        require(contributions[msg.sender] > 0, "SEEDROUND:invalid");
        require(block.timestamp > timeEnd, "SEEDROUND:time_invalid");
        ...
        require(_amountwithdrawNow > 0, "SEEDROUND:AMOUNT_INVALID");
    ...
    function contribute() public payable {
        ...
        require(msg.value >= minBuy, "SEEDROUND:MINIMUM");

        require(maxWeiRaised >= weiRaised.add(msg.value), "SEEDROUND:maxWeiRaised");
    ...
    function takeAmountToken(address _address) public onlyOwner {
        ...
        require(_amount > 0, "SEEDROUND:AMOUNT_INVALID");
